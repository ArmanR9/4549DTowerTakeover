...
public:
  ...
  //Setters
  void set_angularV(double aV){ m_angularV = aV; }
  ...
  // Getters
  double get_angularV(){ return m_angularV; }
...
void set_vel_L(double l){ m_vel_L = l ;}
void set_vel_R(double r){ m_vel_R = r; }
...
double get_vel_L(){ return m_vel_L;}
double get_vel_R(){ return m_vel_R;}
